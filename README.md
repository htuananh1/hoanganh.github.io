...
- Highlights the suggested move with colored overlays and a floating label with the algebraic squares.
...
- The extension polls the ChessHub API when the position changes (every 2 seconds by default) and reuses the ChessHub CSRF token automatically.
